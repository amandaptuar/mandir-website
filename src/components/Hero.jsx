    ...
    <section className="hero">
      ...
      <div className="container hero-content animate-fade-in">
        ...
        <div className="hero-buttons">
          <a href="https://wa.me/918948413360" target="_blank" rel="noopener noreferrer" className="btn btn-primary">Book on WhatsApp</a>
          <a href="https://wa.me/918948413360" target="_blank" rel="noopener noreferrer" className="btn btn-outline" style={{ borderColor: 'white', color: 'white' }}>Enquire Now</a>
        </div>
      </div>
    </section>
  );
